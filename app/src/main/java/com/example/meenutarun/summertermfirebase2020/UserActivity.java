...
public class UserActivity extends AppCompatActivity {
    ...
    public void upLoadFile(Uri uri)
    {
        ...
        StorageReference sr = storageReference.child(child1+System.currentTimeMillis());
         sr.putFile(uri);
    }
    ...
    public void displayDetails()
    {
       root.addValueEventListener(new ValueEventListener() {
           ...
           public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               //StorageReference sr = storageReference.child(auth.getCurrentUser().getUid());
               Log.d("Tag",child1+System.currentTimeMillis());
               StorageReference sr = storageReference.child(child1+System.currentTimeMillis());
    ...
    public void doAdd(View view)
    {
        ...
        final EditText type =(EditText) v.findViewById(R.id.tvmylayout);
